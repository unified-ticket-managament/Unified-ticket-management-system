...
// One feed row — its own component (not inlined in the .map() below)
// so each row can independently track its own expanded/collapsed
// state via useCollapsibleMessage.
