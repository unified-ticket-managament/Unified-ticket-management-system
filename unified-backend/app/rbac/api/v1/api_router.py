...
from app.rbac.api.v1.auth import router as auth_router
from app.rbac.api.v1.users import router as users_router
from app.rbac.api.v1.roles import router as roles_router
from app.rbac.api.v1.categories import router as categories_router
from app.rbac.api.v1.role_permissions import router as role_permissions_router
from app.rbac.api.v1.permissions import router as permissions_router
